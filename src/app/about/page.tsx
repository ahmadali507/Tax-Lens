        ...
        <PageBackground>
            <div className="container mx-auto px-4 py-24">
                <div className="mx-auto max-w-4xl">
                    ...
                    {/* Core Features */}
                    <div className="mb-12">
                        <h2 className="mb-6 text-2xl font-bold text-foreground">Core Features</h2>
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            <Card className="glass glass-border hover-lift">
                                <CardHeader>
                                    <CardTitle className="text-lg text-card-foreground">Data Visualization</CardTitle>
                                </CardHeader>
                                <CardContent className="text-sm text-muted-foreground">
                            ...
                            <Card className="glass glass-border hover-lift">
                                <CardHeader>
                                    <CardTitle className="text-lg text-card-foreground">Personal Insights</CardTitle>
                                </CardHeader>
                                <CardContent className="text-sm text-muted-foreground">
                    ...
                    {/* Design Identity */}
                    <Card className="mb-12 glass glass-border">
                        <CardHeader>
                            <CardTitle className="text-card-foreground">Design Identity</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-4 text-muted-foreground">
                            <div>
                    ...
                    {/* Team */}
                    <div>
                        <h2 className="mb-6 text-2xl font-bold text-foreground">Our Team</h2>
                        <div className="grid gap-6 md:grid-cols-3">
                            <Card className="glass glass-border hover-lift">
                                <CardHeader>
                                    <CardTitle className="text-lg text-card-foreground">Ahmad Ali Shahid</CardTitle>
                            ...
                            <Card className="glass glass-border hover-lift">
                                <CardHeader>
                                    <CardTitle className="text-lg text-card-foreground">Abdul Hadi Asad</CardTitle>
                                    <p className="text-sm text-muted-foreground">
                                        UI/UX Designer
                                    </p>
                                </CardHeader>
                            ...
                            <Card className="glass glass-border hover-lift">
                                <CardHeader>
                                    <CardTitle className="text-lg text-card-foreground">Muhammad Hassan Ali</CardTitle>
